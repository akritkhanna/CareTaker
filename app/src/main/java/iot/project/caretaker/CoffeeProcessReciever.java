...
public class CoffeeProcessReciever extends BroadcastReceiver {
    Processes prc_data;
    @Override
    public void onReceive(final Context context, Intent intent) {
        ...
        prc_data.getCoffee().enqueue(new Callback<ServerData>() {
            ...
            public void onResponse(Call<ServerData> call, Response<ServerData> response) {
                ...
                PendingIntent pendingIntent = PendingIntent.getActivity(context,10,to_reminders_activity,PendingIntent.FLAG_UPDATE_CURRENT);
                String CHANNEL_ID = "coffee";
